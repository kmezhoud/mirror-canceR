...
#   non.interactive.run: Run in interactive (i.e. R GUI) or batch (R command line) mode (default: FALSE) 
...
#   adjust.FDR.q.val: Adjust the FDR q-vals (default: FALSE) 
...
GSEA.Analyze.Sets <- function(directory,topgs= "",non.interactive.run=FALSE,height=12,width=17) {
